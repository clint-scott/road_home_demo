(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/api.js":[function(require,module,exports){
...
},{}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/widget.js":[function(require,module,exports){
// Copyright 2016 Inkling Systems, Inc.
//
// Your use of this software is governed by your customer agreement with Inkling Systems, Inc.
// (e.g., the Master Subscription and Professional Services Agreement).  If you are acting as a
...
},{"./api":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/api.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/engagement/index.js":[function(require,module,exports){
// Copyright 2016 Inkling Systems, Inc.
//
// Your use of this software is governed by your customer agreement with Inkling Systems, Inc.
// (e.g., the Master Subscription and Professional Services Agreement).  If you are acting as a
...
},{"../../lib/widget":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/widget.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/link/index.js":[function(require,module,exports){
// Copyright 2016 Inkling Systems, Inc.
//
// Your use of this software is governed by your customer agreement with Inkling Systems, Inc.
// (e.g., the Master Subscription and Professional Services Agreement).  If you are acting as a
...
module.exports = function(window){
    return new WidgetLinkAPI(window);
};

/**
 * Widget API for opening external links.
 */
function WidgetLinkAPI(window){
    this.api_ = api(window);
 ...
 * Removes this implementation of the API from the window.
 */
WidgetLinkAPI.prototype.remove = function(){
    this.api_.remove();
    this.engagement_.remove();
};

/**
 * Sends a request to open the given URL.
 *
 * @param {string} href The HREF to open.
 */
WidgetLinkAPI.prototype.open = function(href){
    this.api_.send('link', 'open', {
        href: href
    });
};

},{"../../lib/widget":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/widget.js","../engagement":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/engagement/index.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/orientation/index.js":[function(require,module,exports){
// Copyright 2016 Inkling Systems, Inc.
//
// Your use of this software is governed by your customer agreement with Inkling Systems, Inc.
// (e.g., the Master Subscription and Professional Services Agreement).  If you are acting as a
...
module.exports = function(window){
    return new WidgetOrientationAPI(window);
};

/**
 * Widget API for reciving notifications of device orientation change.
 */
function WidgetOrientationAPI(window){
    this.api_ = api(window);
    this.engagement_ = engagement(window);
}
 ...
 * Removes this implementation of the API from the window.
 */
WidgetOrientationAPI.prototype.remove = function(){
    this.api_.remove();
    this.engagement_.remove();
};

/**
 * Attachs a listener for changes in orientation on Inkling native clients where
 * 'window.onorientationchange' will not work.
 *
 * @param {orientationChangeCallback} callback The callback to trigger when orientation changes.
 */
WidgetOrientationAPI.prototype.onChange = function(callback){
    this.api_.listen('orientationchange', null, function(payload){
        callback(payload.orientation);
    });
};

/**
 * This callback is called when an image has been uploaded.
 * @callback orientationChangeCallback
 * @param {number} orientation The orientation value of the widget, one of 0, 90, 180, or -90.
 */

},{"../../lib/widget":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/widget.js","../engagement":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/engagement/index.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/view/index.js":[function(require,module,exports){
// Copyright 2016 Inkling Systems, Inc.
//
// Your use of this software is governed by your customer agreement with Inkling Systems, Inc.
// (e.g., the Master Subscription and Professional Services Agreement).  If you are acting as a
...
module.exports = function(window){
    return new WidgetViewAPI(window);
};

/**
 * The widget view API for adjusting widget size in the parent window.
 */
function WidgetViewAPI(window){
    this.doc_ = window.document;
    this.api_ = api(window);
    this.engagement_ = engagement(window);
}
 ...
 * Removes this implementation of the API from the window.
 */
WidgetViewAPI.prototype.remove = function(){
    this.api_.remove();
    this.engagement_.remove();
};
 ...
 */
WidgetViewAPI.prototype.setSize = function(width, height){
    var params = {};
    if (typeof width !== 'undefined') params.width = width;
    if (typeof height !== 'undefined') params.height = height;

    // TODO(logan): Remove this when all clients support the newer 'view:set' message (#29674).
    this.api_.send('size', 'set', params);

    // Send the proper 'view:set' message. Even though we are sending duplicate messages, this
    // should really not be too big of a deal since they are tiny.
    this.api_.send('view', 'set', params);
};
 ...
 * @param {number|string} width The new width, as a number of pixels, or a string with units.
 */
WidgetViewAPI.prototype.setWidth = function(width){
 ...
 * @param {number|string} height The new height, as a number of pixels, or a string with units.
 */
WidgetViewAPI.prototype.setHeight = function(height){
 ...
 */
WidgetViewAPI.prototype.fitToHeight = function(){
    // Note: We use <body> AND <html> because we were having issue with reading the size
    // of the <html> element in Firefox. Specifically, the height of the Annotated Image widget
    // was read as too large when loading non-cached.
    // If a widget REALLY needs to set a margin on the <body> then it can always use 'setHeight'
    // directly to set the height.
    var height = Math.min(this.doc_.documentElement.scrollHeight, this.doc_.body.scrollHeight);
    this.setHeight(height);
};

},{"../../lib/widget":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/widget.js","../engagement":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/engagement/index.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/inkling-jQuery/index.js":[function(require,module,exports){
module.exports = require('jquery');

},{"jquery":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/inkling-jQuery/node_modules/jquery/dist/jquery.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/inkling-jQuery/node_modules/jquery/dist/jquery.js":[function(require,module,exports){
/*!
...
},{}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/inkling-widget-config/index.js":[function(require,module,exports){
...
module.exports=require("/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/api.js")
...
module.exports=require("/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/lib/widget.js")
},{"./api":"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/inkling-widget-config/node_modules/@inkling/widget-api/lib/api.js"}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/inkling-widget-config/node_modules/@inkling/widget-api/widget/engagement/index.js":[function(require,module,exports){
module.exports=require("/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/node_modules/@inkling/widget-api/widget/engagement/index.js")
...
},{}],"/Users/clintonscott/web/widgets/widgets/cgs_demo_flow_chart_01/src/view.js":[function(require,module,exports){
var $ = jQuery = window.$ = window.jQuery = require('inkling-jQuery');

var setup = require('../src/view');
var viewAPI = require('@inkling/widget-api/widget/view')(window);
var linkAPI = require('@inkling/widget-api/widget/link')(window);
var orientationAPI = require('@inkling/widget-api/widget/orientation')(window);


require('inkling-widget-config')(require('./config'), function(err, config){
    var data = config.get();
...
function resizeWidget() {
	var newDocHeight = $(document).outerHeight(true)+100;

	//viewAPI.fitToHeight();
	viewAPI.setHeight(newDocHeight);
}
...
function initListeners() {
	...
	orientationAPI.onChange(function(data){
		resizeWidget();
	});
	...
	$(document).on('click', '.popup .btn-link', function (e) {
		var url = $(this).data().url;
		linkAPI.open(url);
		//window.open(url, '_blank');
	});

	$(document).on('click', '.comp .btn-open', function (e) {
		var parent = $(this).closest('.comp');
		var popupID = parent.data().popup;
		var parentOffsetTop = parent.offset().top +  - 50;
		var parentOffsetBottom = $('.flow-chart').outerHeight() - (parent.offset().top + parent.outerHeight() + 50);

		var belowHalf = parentOffsetTop > $('.flow-chart').height()/2;
		
		var top = belowHalf ? 'auto' : parentOffsetTop;
		var bottom = belowHalf ? parentOffsetBottom : 'auto';
	...
	$(document).on('click', '.comp.header', function (e) {
...
function initBuild() {
	var isOpen = $('.comp.header').hasClass('open'),
		opacity = isOpen ? 1 : 0,
		mTop = isOpen ? 0 : '-8rem',
		mBottom = isOpen ? '-0.5rem' : '8rem';

	var delay = 100;
	
	var objects = $('.flow-chart .flow-obj').toArray();
	...
	objects.map(function(obj, index) {
		var flowObj = $(obj).not('.comp.header');
		
		setTimeout(function() {
			if(isOpen) {
				flowObj.toggleClass('hidden', false);
			}
			else {
				setTimeout(function() {
					flowObj.toggleClass('hidden', true);
					resizeWidget();
				},450);
			}
